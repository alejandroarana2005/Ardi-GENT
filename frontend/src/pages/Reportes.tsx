  ...
  return (
    <div className="page">
      <div className="page-head">
        <div>
          <div className="mono" style={{ fontSize: 10, color: "var(--muted)", letterSpacing: "0.12em" }}>HORARIO 2024-A · sch_2024A_v07</div>
            ...
            {data.PROFS.map(p => {
              ...
              return (
                <tr key={p.code}>
                  ...
                  <td className="num">
                    <span style={{ color: pref > 0.75 ? "var(--ok)" : pref > 0.55 ? "var(--ink)" : "var(--conflict-ink)" }}>
                      {pref.toFixed(2)}
                    </span>
                  </td>
                </tr>
